...
const KNOWN_TOOLS = ["file_read", "file_write", "web_search", "http_request", "dispatch_task", "spawn_agent", "git_status", "git_diff", "gitea_repo_inspect", "gitea_repo_tree", "gitea_repo_file", "gitea_repo_commits", "gitea_repo_diff"];
